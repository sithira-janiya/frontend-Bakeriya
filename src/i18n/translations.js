...
export const translations = {
  en: {
    ...
    'chef.enterPinDesc': 'Enter the staff PIN to view and manage incoming orders.',
    'chef.pinPlaceholder': 'Staff PIN',
    'chef.enterPanel': 'Enter Panel',
    'chef.incorrectPin': 'Incorrect PIN. Try again.',
  ...
  si: {
    ...
    'chef.enterPinDesc': 'එන ඇණවුම් බැලීමට සහ කළමනාකරණය කිරීමට කාර්ය මණ්ඩල PIN අංකය ඇතුළත් කරන්න.',
    'chef.pinPlaceholder': 'කාර්ය මණ්ඩල PIN',
    'chef.enterPanel': 'පැනලයට ඇතුළු වන්න',
    'chef.incorrectPin': 'වැරදි PIN අංකයකි. නැවත උත්සාහ කරන්න.',
